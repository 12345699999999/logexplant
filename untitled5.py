...
Original file is located at
    https://colab.research.google.com/drive/13w-X5Uw0mdnYEgj2YYNCbH2xWGOsjk-C
"""
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if not result_df.empty:
            ...
            # Allow users to download the result as CSV
            csv = result_df.to_csv(index=False).encode('utf-8')
            st.download_button(
                label="Download Replenishment Plan as CSV",
                data=csv,
